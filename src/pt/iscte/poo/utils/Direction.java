...
public enum Direction implements Serializable {
	...
	public static Direction directionFor(int keyCode) {  //dada uma tecla válida, saber para onde vai a personagem
		switch(keyCode){
	...
	public static boolean isDirection(int lastKeyPressed) {		 //se é válida a direção
